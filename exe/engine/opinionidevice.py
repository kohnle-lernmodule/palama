...
# ===========================================================================
class OpinionQuestion(Persistable):
    """
    A Opinion iDevice is built up of questions.  Each question can
    ...
    def upgrade_setIdevice(self, idevice):
        ...
        this method allows the parent OpinionIdevice to merely set
