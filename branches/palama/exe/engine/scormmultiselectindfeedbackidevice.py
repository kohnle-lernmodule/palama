...
#changed ktlm 130108 use field with individual feedback
from exe.engine.field     import SelectQuestionIndFeedbackField
#END :changed ktlm 130108 use field with individual feedback
log = logging.getLogger(__name__)


class ScormMultiSelectIndFeedbackIdevice(Idevice):
    """
    A ScormMultiSelectIndFeedback Idevice is one built up from question and options
    """
    ...
    def __init__(self):
        ...
        Idevice.__init__(self,
                         x_(u"SCORM Test MC individual Feedback"),
...
"""), u"question")
    ...
    def addQuestion(self):
        ...
        """
        question = SelectQuestionIndFeedbackField(self, x_(u'Question'))
        question.addOption()
