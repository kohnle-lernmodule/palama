...
try{
	if (document.getElementsByTagName("html")[0].lang == "de") YOUR_SCORE_IS = "Der Punktestand ist ";
	else if (document.getElementsByTagName("html")[0].lang == "es") YOUR_SCORE_IS = "Tu puntuación es ";
}
catch (e) {}
